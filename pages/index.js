    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-2xl p-6">
        ...
        <section className="mb-6">
          ...
          <p className="mb-2">Utilisez la clé API et la signature HMAC-SHA256 pour sécuriser vos requêtes.</p>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside">
            <li><code>POST /api/v1/payment/initiate</code></li>
            <li><code>GET /api/v1/payment/status/:id</code></li>
            <li><code>POST /api/v1/payout/initiate</code></li>
          </ul>
        </section>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside">
            ...
            <li><strong>500</strong> : Erreur interne</li>
          </ul>
        </section>
      </div>
    </div>
